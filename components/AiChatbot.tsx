...
const WELCOME: UiMessage = {
  ...
  role: 'assistant',
  content:
    'שלום! אני העוזר הדיגיטלי של בינה לתעשייה. אפשר לשאול על אפיון תהליכים, כתיבת נהלים (SOPs) לרוחב העסק, סדנאות Hands-on ובניית סוכנים ממוקדים, או לתאם שיחת אבחון עם אוהד.',
};
