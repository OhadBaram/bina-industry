...
export const AccessibilityStatementModal: React.FC<AccessibilityStatementModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className={`fixed inset-0 z-50 bg-slate-900/80 backdrop-blur-md flex items-center justify-center p-4 md:p-6 transition-opacity duration-300 ${
      ...
      <div className={`bg-white dark:bg-slate-900 rounded-[2.5rem] p-6 md:p-10 max-w-2xl w-full max-h-[85vh] overflow-y-auto text-right shadow-2xl border border-slate-200 dark:border-slate-800 relative space-y-6 ${
