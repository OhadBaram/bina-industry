      ...
      {viewMode === 'admin' ? (
        ...
        <>
          ...
          <div className="px-3">
            <SubTabNav
              tabs={[
                { id: 'active', label: `פגישות פעילות (${activeAppointments.length})` },
                { id: 'history', label: 'היסטוריה' },
                { id: 'services', label: 'שירותים ומחירון' },
                { id: 'about', label: 'אודות ומדיניות' },
              ]}
              activeTab={activeTab}
                ...
                {activeAppointments.length === 0 ? (
                  <div className="bg-white rounded-3xl p-6 text-center border border-slate-200 space-y-2.5">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white rounded-xl text-xs font-black shadow-sm transition-all"
                    >
                      תיאום פגישה חדשה ➔
                    </button>
                  </div>
                  ...
                  <div key={s.id} className="bg-white rounded-2xl p-3 border border-slate-200 shadow-xs flex items-center justify-between">
                    ...
                    <div className="text-left space-y-1.5">
                      ...
                      <button
                        ...
                        className="px-2.5 py-1 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-black text-[10px] rounded-lg shadow-xs cursor-pointer transition-all"
                      >
                        תיאום
                      </button>
                    </div>
