...
export const METHODOLOGY_STEPS: MethodologyStep[] = [
  ...
  {
    stepNum: '02',
    title: 'אפיון ארכיטקטורה',
    shortDesc: 'בחירת מודלים ותשתיות',
    details: 'בחירת המודלים, הכלים, והגדרת תשתיות האוטומציה המתאימות ביותר לארגון.',
    icon: '📐'
  },
  {
    stepNum: '03',
...
export const B2B_SERVICES: B2BService[] = [
  ...
  },
  {
    ...
    subtitle: 'אוטומציות ואינטגרציות תפעוליות',
    title: 'חיבור שרשרת התפעול ללא מגע יד אדם',
    icon: '⚡',
    shortDesc: 'יצירת זרימות עבודה חכמות בין מערכות הליבה: קליטת לידים וניתובם, הפקת הצעות מחיר, סנכרון מסמכים ועדכון מערכות ERP ו-CRM באמינות מלאה.',
    features: [
      'קליטת לידים, ניתובם והפקת הצעות מחיר אוטומטית',
      'סנכרון מסמכים ועדכון מערכות ERP ו-CRM',
      'אפס תקלות – אוטומציה עמידה בעומסים',
      'זרימת מידע רציפה ללא מגע יד אדם'
    ],
    techBadges: ['אפס תקלות', 'עמידות בעומסים', 'Make & n8n'],
