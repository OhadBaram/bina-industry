...
export const METHODOLOGY_STEPS: MethodologyStep[] = [
  ...
  {
    stepNum: '02',
    title: 'אפיון תהליכים ומסמכים (SOPs)',
    shortDesc: 'בניית תבניות ומתודולוגיה מותאמת',
    details: 'תרגום צרכי העסק למסמכי עבודה חכמים (SOPs, הצעות מחיר, דרישות) והגדרת פרומפטים מדויקים לביצוע מהיר ונטול שגיאות.',
    icon: '📐'
  },
  {
    stepNum: '03',
...
export const B2B_SERVICES: B2BService[] = [
  ...
  },
  {
    ...
    title: 'אפיון תהליכי עבודה ומסמכים (SOPs)',
    icon: '📝',
    shortDesc: 'הפיכת משימות מורכבות כמו כתיבת הצעות מחיר, נהלי עבודה (SOPs), ומסמכי דרישות (PRD) לתהליך חכם, מהיר ומדויק מבוסס AI.',
    features: [
      'אפיון תבניות עבודה חכמות המבוססות על הידע והסטנדרט של העסק',
    ...
    techBadges: ['Business SOPs', 'PRD & Proposals', 'Workflow Optimization'],
    ctaText: 'לתיאום שיחת אפיון תהליכים ומסמכים'
  },
  {
    id: 'workshops',
    num: '03',
...
export const PAIN_POINTS: PainPointItem[] = [
  {
    ...
    solution: 'שילוב בין ניהול מוצר ואפיון תהליכים מדויק לבין הכשרה מעשית hands-on. אנחנו מתאימים את הכלים ישירות למשימות האמיתיות של העסק.'
  }
];
