...
export const METHODOLOGY_STEPS: MethodologyStep[] = [
  ...
  },
  {
    ...
    details: 'רוב פרויקטי ה-AI נכשלים כי מחברים כלים באקראי. אנחנו מאפיינים תשתית מלאה ברמת Technical Product Management: מיפוי כל נקודת קצה (Endpoint), תכנון נתיבי המידע בין המחלקות, בחירת המודל האופטימלי לכל משימה והגדרת תרחישי קצה. בונים נכון מהיסוד, כדי שלא תצטרכו לתקן בעוד חודשיים.',
    icon: '📐'
  },
  {
    stepNum: '03',
