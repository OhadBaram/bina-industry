...
export const B2B_SERVICES: B2BService[] = [
  {
    ...
    features: [
      ...
      'יצירת מסמכי דרישות, הצעות מחיר ונהלים בלחיצת כפתור',
      'חיסכון של עשרות שעות עבודה ידניות וחזרתיות',
      'דיוק מרבי ומניעת טעויות אנוש בניסוחים עסקיים'
    ],
    techBadges: ['SOPs Generator', 'PRD & Proposals', 'Workflow Optimization'],
...
export const USE_CASES: UseCase[] = [
  {
    ...
    steps: [
      ...
      { num: '04', title: 'הפקת תוצר מושלם', desc: 'קבלת מסמך עסקי מדויק ומוכן לעבודה תוך חיסכון של 80% מהזמן' }
    ],
